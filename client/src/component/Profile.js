                ...
                <div className="card-body ">
                  ...
                  <div className="row">
                    <div className="col-sm-5">
                      <h6 className="mb-0">Business/Organisation</h6>
                    </div>
              ...
              <div className="col-sm-6 mb-3 p-2">
                <div className="card h-100">
                  <div className="card-body">
                    ...
                    <div className="progress mb-3" olelelele="height: 5px">
                      <div
...
// address: "Nalco Gate";
// business_organization: "Victor";
// comments: " utilities on flexbox containers to change the alignment of flex items on the main axis (the x-axis to start, y-axis if flex-direction: column). Choose from start (browser default), end, center, between, or around.";
// date: "2024-02-28T15:25:27.376Z";
// dob: "2001-10-20T00:00:00.000Z";
// email: "aksingh@gmail.com";
// get: "bumca_student_details";
// name: "Akashdeep Singh";
// passing_year: 2003;
// phone: "1234561234";
// position: "Senio Marketing";
// profession: "Huck-up";
// website: "victor.in";
// __v: 0;
// _id: "65df53af0375f770cfc28ea4";
